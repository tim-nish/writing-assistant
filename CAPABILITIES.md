...
| `harvest` | Gathered source-pointed facts into a fact sheet. RETIRED 2026-08-02 (#1182, story 20.147): the feasibility read is `probe`, grounding is per-claim `examine`. | retired | 2026-07-11 | — | `specs/spec-writing-assistant/amendments.md` | — |
| `examine` | Answers one stated claim from the repository: pinned material out, coverage reported, scope derived from the brief; the tool never judges. | implemented | 2026-08-02 | `scripts/check-examine.sh` | `specs/spec-writing-assistant/amendments.md` | — |
