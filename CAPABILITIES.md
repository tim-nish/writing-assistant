...
| `harvest` | Gathered source-pointed facts into a fact sheet. RETIRED 2026-08-02 (#1182, story 20.147): stage 1 is `probe`, grounding is per-claim `examine`. | retired | 2026-07-11 | — | `specs/spec-writing-assistant/amendments.md` | — |
