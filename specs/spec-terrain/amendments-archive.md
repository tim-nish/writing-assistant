# SPEC-terrain — ratified amendments, 2026-07-24 → 2026-07-29

Archive companion to `SPEC.md` (listed in its `companions:` frontmatter),
holding the ratified amendment blockquotes of SPEC-terrain dated **2026-07-24
through 2026-07-29**, relocated **verbatim** from `amendments.md` on
2026-07-31 — no rewording, no merging, nothing compacted, per *ratified
amendment text is never compacted* (Story 20.15, #819).

Why this file exists: the 2026-07-27 amendment-history-companion decision
(#829) moved SPEC-terrain's amendments out of `SPEC.md` to stop that file
absorbing per-sitting byte growth (Story 20.16). The companion then absorbed
the same growth and reached the 72,000-byte spec ceiling itself on
2026-07-31. This is that same ratified remedy applied one level down, cut at
a **date boundary** so no judgment is exercised over which ratified text goes
where.

**Nothing appends here.** New amendments append to `amendments.md`,
newest-last. This file is closed at 2026-07-29.
